<script>
	...
	import SideCurtain from "./components/SideCurtain.svelte";

	let navbar;
	let sideSlider;

	export function doOpenCurtain() {
		sideSlider.openCurtain();
	}
...
<Hero img="./img/stars.jpg">
	<h1>Svelte Component Demo and App Template</h1>
